...
from .models import Cateegory, MenuItem, Cart, Order, OrderItem
import bleach
...
class MenuItemSerializer(serializers.ModelSerializer):
    ...
    def validate_title(self, value):
            ...
            if value.isalnum() != True:
                raise serializers.ValidationError("Title must contain only alpha-numeric values")
            return value
    ...
    class Meta:
        model = MenuItem
        fields =['title','featured','category','category_id']
